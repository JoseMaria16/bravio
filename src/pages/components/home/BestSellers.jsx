  ...
  return (
    <div className='h-max'>
            ...
            <div className='flex sm:flex-col lg:flex-row'>
                <img className='lg:w-[60%] h-1/2 -mt-10 sm:w-[70%] mx-auto md:[40%]' src="../gorro1.png" alt="" />
            ...
            {data.map((element) => (
                <div key={element.id} className='border-4 border-gray-100'>
                    ...
                    <img className='w-2/3 mx-auto py-5 px-2 h-[100%] hover:rotate-12 duration-700 hover:scale-75 xl:w-1/2 xl:px-0' src={element.img} alt="" />
                    </div>
                    ...
                    <p className=' text-xs mx-auto mt-2 border-1 xl:mb-0 rounded-lg bg-gray-100 w-max px-3 py-1 sm:mb-2 xl:pb-2'>see more.</p>
                </div> 
            ))}
            </div>
            </div>
